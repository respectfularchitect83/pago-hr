...
const TaxReport: React.FC<ReportProps> = ({ employees, companyInfo, startDate, endDate, selectedBranch }) => {
    
    const taxDescription = countryRegulations[companyInfo.country].tax.description;
    ...
    }, [employees, startDate, endDate, taxDescription, selectedBranch]);
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold text-gray-700">Tax Report Results</h3>
                <button
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {reportData.length > 0 ? reportData.map((row, index) => (
                            ...
                            <tr>
                                <td colSpan={5} className="text-center py-8 text-gray-500">No tax data found for the selected period.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
